...
uvwasi_errno_t uvwasi_fd_permissions_set(uvwasi_t* uvwasi,
  ...
  DEBUG("uvwasi_fd_permissions_set(uvwasi=%p, fd=%d, permissions=%d)\n",
        uvwasi,
        fd,
        permissions);
...
uvwasi_errno_t uvwasi_path_open(uvwasi_t* uvwasi,
  ...
  DEBUG("uvwasi_path_open(uvwasi=%p, dirfd=%d, dirflags=%d, path='%s', "
        ...
        "fs_rights_inheriting=%"PRIu64", fs_flags=%d, permissions=%d, fd=%p)\n",
        uvwasi,
        dirfd,
        dirflags,
        path,
...
uvwasi_errno_t uvwasi_path_permissions_set(uvwasi_t* uvwasi,
  ...
  DEBUG("uvwasi_path_permissions_set(uvwasi=%p, fd=%d, flags=%d, path='%s', "
        "path_len=%zu, permissions=%d)\n",
        uvwasi,
        fd,
        flags,
        path,
